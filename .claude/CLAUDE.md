...
### Always give PR descriptions in a copyable markdown code block

- When providing a PR description, always wrap the entire content in a fenced markdown code block so the user can copy it directly.
...
| Sidebar nav or menu items | `docs/nav-system.md` |
| Sparklines or charts | `docs/ui-components.md` (InteractiveSparkline section) |
