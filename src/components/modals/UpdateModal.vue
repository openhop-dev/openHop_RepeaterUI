      ...
      >
        ...
        <div class="p-6 space-y-5 overflow-y-auto flex-1">
          ...
          <div
            ...
            class="flex items-start gap-3 bg-accent-amber/10 border border-accent-amber/30 rounded-xl p-3"
          >
            <svg
          ...
          >
            <div class="flex items-center justify-between">
              ...
              >
                <span class="inline-block w-2 h-2 rounded-full status-dot-amber animate-pulse"></span>
          ...
          <div v-else-if="installState === 'restarting' && logLines.length === 0">
            <div
              class="flex items-center gap-3 bg-accent-amber/10 border border-accent-amber/30 rounded-xl p-3 text-sm text-accent-amber"
            >
              <Spinner size="sm" class="shrink-0" />
              <div>
                <p class="font-medium">
