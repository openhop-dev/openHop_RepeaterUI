...
Web dashboard for [openHop Repeater](https://github.com/openhop-dev/openhope-repeater) — monitor and manage your openHop repeater entirely from the browser.
...
- **Node.js** 20 or later
- A running [openHop Repeater](https://github.com/openhop-dev/openhope-repeater) backend
...
The compiled output is written to `../openhope-repeater/repeater/web/html` and served directly by the repeater.
